...
<meta charset="utf-8">
	...
	<link rel="stylesheet" type="text/css" href="AddNewTeam.css"/>
	<script type="text/javascript" src="http://code.jquery.com/jquery.min.js"></script>
	<script type="text/javascript"></script>
	<script src = "AddNewTeam.js"></script>
...
<ul id="navigation">
		...
		<div id="popupdivalready" onclick="hide_me()" onmouseover ="show_me_more()" onmouseleave = "rehide_me()">
			Selected user is already a team leader !
		</div>
		<div class ="first_div">
							<br>
								<span  class ="label_header">Add New Team</span>   <br>
								<div class="field">
								<br>
								...
								<div class="field">
										...
										<input name="teamName" id="teamName" type="text"> </input>
