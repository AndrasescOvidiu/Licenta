...
<body onload="loadTable(),setTable(),afisare_tip_user(),startTime(),getAllWeeks1()" id="bodyId">

	<ul id="navigation">
			
				<li class="dropdown"> <a href ="/Quality/TimeToolTry/HomePage/HomePageTag/homePage.php"> Home </a> </li>
				
				<li class="dropdown"> <a href ="#"> Tasks </a> 
				...
				<li class="dropdown" id="Projects"> <a href ="#">Projects </a>
					<ul class="dropdown-content">
				...
				<li class="dropdown" id="Teams" > <a href ="#">Teams </a>
					<ul class="dropdown-content">
				...
				<li class="dropdown"> <a href ="#"> Weekly Report </a> 
					<ul class="dropdown-content" >
						<a href ="#"> Add Weekly Report </a>
						<a href	="#"> View Weekly Report </a>
						<a href ="#"> Edit Weekly Report </a>
						<a href ="#"> View Monthly Report </a>
					</ul>
				</li>
